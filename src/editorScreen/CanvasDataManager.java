    ...
    protected CanvasDataManager(double x, double y, double width, double height, Color bgColor) {
        ...
        try {
            ...
            newProject = new Button(0, 0, 0, 0, np, "new Project", () -> {
                ComponentManager.newCanvas(Integer.parseInt(JOptionPane.showInputDialog("enter the length dimension")), Integer.parseInt(JOptionPane.showInputDialog("enter the height dimension")));
            });
            add(newProject);
